...
public class Device implements org.cybergarage.http.HTTPRequestListener,
    ...
    /**
     * serviceList
     * It will return data only after
     * */
    ...
    public boolean equals(Object o) {
        ...
        return !(devUUID != null ? !devUUID.equals(device.devUUID) : device.devUUID != null);

    }

    @Override
    public int hashCode() {
        return devUUID != null ? devUUID.hashCode() : 0;
    }
}
