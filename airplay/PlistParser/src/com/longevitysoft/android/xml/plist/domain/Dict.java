...
public class Dict extends PListObject {
     ...
     * previous token key.
     *
     * @param key The fully qualified key text.
     ...
     *
     * @param key The text of the key to look up in the configuration
     *            dictionary.
     ...
     * @param key          The text of the key to look up in the configuration
     *                     dictionary.
     * @param defaultValue The default value to return if they key has no associated
     *                     value.
